...
{
    public partial class historyreturndisplay : UserControl
    {
        dropDownBooklist dropDownBooklist;
        private bool isDropDownAdded = false;

        public DateTime ReturnDate { get; set; }
        public historyreturndisplay()
        {
            InitializeComponent();
        ...
        public historyreturndisplay(string referenceID, string memberID, string borrowdate, string returndate) : this()
        {
