...
{
    public partial class returnHistoryLayout : UserControl
    {
        dropDownBooklist dropDownBooklist;
        private bool isDropDownAdded = false;

        public DateTime ReturnDate { get; set; }
        public returnHistoryLayout()
        {
            InitializeComponent();
        ...
        public returnHistoryLayout(string referenceID, string memberID, string borrowdate, string returndate) : this()
        {
