...
namespace WindowsFormsApp1
{
    public partial class allBorrowLayout : UserControl
    {
        ...
        public allBorrowLayout(string referenceID, string memberID, string borrowdate, string returndate) : this()
        {
